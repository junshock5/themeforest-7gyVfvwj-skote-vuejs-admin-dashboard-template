...
<Layout>
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4 pt-3">
                        ...
                        <b-form-checkbox id="productdiscountCheck1" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountLessFilter($event, 10)">Less than 10%</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck2" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 10)">10% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck3" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 20)">20% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck4" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 30)">30% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck5" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 40)">40% or more</b-form-checkbox>

                        <b-form-checkbox id="productdiscountCheck6" class="mt-2" value="accepted" unchecked-value="not_accepted" @change="discountMoreFilter($event, 50)">50% or more</b-form-checkbox>
                    </div>
                    ...
                    <div class="mt-4 pt-3">
                        ...
                        <div>
                            ...
                            <b-form-checkbox id="checkbox-2" class="mt-2" name="checkbox-2" value="accepted" unchecked-value="not_accepted">
                                3
                                <i class="bx bx-star text-warning"></i> & Above
                            </b-form-checkbox>

                            <b-form-checkbox id="checkbox-3" class="mt-2" name="checkbox-3" value="accepted" unchecked-value="not_accepted">
                                2
                                <i class="bx bx-star text-warning"></i> & Above
                            </b-form-checkbox>
                            <b-form-checkbox id="checkbox-4" class="mt-2" name="checkbox-4" value="accepted" unchecked-value="not_accepted">
                                1
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                <div v-for="(item, index) in records" :key="index" class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
