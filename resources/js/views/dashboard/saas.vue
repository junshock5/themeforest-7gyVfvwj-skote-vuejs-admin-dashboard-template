            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <apexchart class="apex-charts" :options="ChartData.LineChart.chartOptions" :series="ChartData.LineChart.series" dir="ltr" height="380"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <apexchart class="apex-charts" :options="ChartData.DonutChart.chartOptions" :series="ChartData.DonutChart.series" dir="ltr" height="300" />
                    </div>
                        ...
                        <table class="table table-centered mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <apexchart class="apex-charts" :options="ChartData.RadialChart2.chartOptions" :height="60" :width="60" :series="ChartData.RadialChart2.series" dir="ltr" />
                                    </td>
                                    <td>
                                        <p class="text-muted mb-1">Sales</p>
                                        <h5 class="mb-0">72 %</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <apexchart class="apex-charts" :options="ChartData.RadialChart3.chartOptions" :height="60" :width="60" :series="ChartData.RadialChart3.series" dir="ltr" />
                                    </td>
                                    <td>
                                        <p class="text-muted mb-1">Sales</p>
                                        <h5 class="mb-0">54 %</h5>
